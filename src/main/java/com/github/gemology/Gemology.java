...
public class Gemology {
    ...
    // Create a Deferred Register to hold Items which will all be registered under the "gemology" namespace
    ...
    // Creates a new Block with the id "gemology:example_block", combining the namespace and path
    public static final DeferredBlock<Block> EXAMPLE_BLOCK = BLOCKS.registerSimpleBlock("example_block", BlockBehaviour.Properties.of().mapColor(MapColor.STONE));
    // Creates a new BlockItem with the id "gemology:example_block", combining the namespace and path
    public static final DeferredItem<BlockItem> EXAMPLE_BLOCK_ITEM = ITEMS.registerSimpleBlockItem("example_block", EXAMPLE_BLOCK);

    // Creates a new food item with the id "gemology:example_id", nutrition 1 and saturation 2
